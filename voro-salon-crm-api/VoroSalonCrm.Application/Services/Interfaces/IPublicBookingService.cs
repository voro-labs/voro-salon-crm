...
namespace VoroSalonCrm.Application.Services.Interfaces
{
    public interface IPublicBookingService
    {
        ...
        Task<IEnumerable<VoroSalonCrm.Application.DTOs.CRM.AvailabilitySlotDto>> GetAvailableSlotsAsync(string tenantSlug, DateTime date, Guid? serviceId = null, Guid? employeeId = null);
    }
