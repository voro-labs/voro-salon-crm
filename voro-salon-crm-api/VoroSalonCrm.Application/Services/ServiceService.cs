...
namespace VoroSalonCrm.Application.Services
{
        ...
        ICurrentUserService currentUserService) : IServiceService
    {
        ...
        public async Task<ServiceDto> CreateAsync(CreateServiceDto dto)
        {
            ...
            return new ServiceDto(service.Id, service.Name, service.Description, service.Price, service.CreatedAt);
        }
        ...
        public async Task<IEnumerable<ServiceDto>> GetAllAsync()
        {
            ...
            return services.Select(s => new ServiceDto(s.Id, s.Name, s.Description, s.Price, s.CreatedAt));
        }
