...
namespace VoroSalonCrm.Infrastructure.Migrations
{
    ...
    [Migration("20260515185208_AddSupportTicketsAndMessages")]
    partial class AddSupportTicketsAndMessages
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VoroSalonCrm.Domain.Entities.EvolutionTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("VoroSalonCrm.Domain.Entities.SupportMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("VoroSalonCrm.Domain.Entities.SupportTicket", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("VoroSalonCrm.Domain.Entities.TenantEvolutionInstanceLink", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("TenantEvolutionInstanceLinks");
                });
            ...
            modelBuilder.Entity("VoroSalonCrm.Domain.Entities.WhatsAppMessage", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("ProcessedByBotAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("VoroSalonCrm.Domain.Entities.SupportMessage", b =>
                {
                    b.HasOne("VoroSalonCrm.Domain.Entities.SupportTicket", "Ticket")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("VoroSalonCrm.Domain.Entities.TenantEvolutionInstanceLink", b =>
                {
                    b.HasOne("VoroSalonCrm.Domain.Entities.TenantEvolutionInstance", "Instance")
                        .WithMany()
