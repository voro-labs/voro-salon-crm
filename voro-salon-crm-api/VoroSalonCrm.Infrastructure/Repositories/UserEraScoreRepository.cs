...
{
    public class UserEraScoreRepository(JasmimDbContext context, IUnitOfWork unitOfWork) : RepositoryBase<UserEraScore>(context, unitOfWork), IUserEraScoreRepository
    {
    }
}
