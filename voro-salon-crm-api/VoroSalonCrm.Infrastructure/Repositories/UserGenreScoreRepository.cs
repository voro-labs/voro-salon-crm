...
{
    public class UserGenreScoreRepository(JasmimDbContext context, IUnitOfWork unitOfWork) : RepositoryBase<UserGenreScore>(context, unitOfWork), IUserGenreScoreRepository
    {
    }
}
