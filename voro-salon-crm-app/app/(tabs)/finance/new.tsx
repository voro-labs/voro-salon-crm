...
import type { CreateTransactionDto } from "types/DTOs/financial.interface"
        ...
        <ScrollView className="flex-1" contentContainerStyle={{ padding: 20 }} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
          ...
          <View className="mb-4">
            ...
            <TextInput
              ...
              placeholder="Ex: Venda de serviço, aluguel..."
