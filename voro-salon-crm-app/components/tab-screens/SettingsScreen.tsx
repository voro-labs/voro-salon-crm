...
export function SettingsScreen({ rootPath = "/(tabs)" }: { rootPath?: string }) {
      ...
      <ScrollView className="flex-1" showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 40 }}>
          ...
          <>
            ...
            <View className="bg-white mx-4 rounded-3xl px-4 border border-zinc-100">
              <NavRow
                ...
                onPress={() => router.push(`${rootPath}/settings/salon` as any)}
              ...
              <NavRow
                ...
                onPress={() => router.push(`${rootPath}/settings/business-hours` as any)}
                iconBg="#fff1f2"
                iconColor="#e11d48"
              />
              <NavRow
                ...
                onPress={() => router.push(`${rootPath}/settings/subscription` as any)}
                iconBg="#fef3c7"
                iconColor="#d97706"
              />
              {isOwner && (
                <NavRow
                  ...
                  onPress={() => router.push(`${rootPath}/settings/modules` as any)}
                  iconBg="#f0f9ff"
                  iconColor="#0284c7"
                />
              )}
              <NavRow
                ...
                onPress={() => router.push(`${rootPath}/settings/export` as any)}
                iconBg="#f0fdf4"
                iconColor="#059669"
              />
              <NavRow
                ...
                onPress={() => router.push(`${rootPath}/settings/membership-plans` as any)}
                iconBg="#fdf4ff"
                iconColor="#c026d3"
              />
              {hasAnamnesis && (
                <NavRow
                  ...
                  onPress={() => router.push(`${rootPath}/settings/anamnesis` as any)}
                  iconBg="#fff7ed"
                  iconColor="#d97706"
                />
              )}
              ...
              {isOwner && (
                <NavRow
                  ...
                  onPress={() => router.push(`${rootPath}/settings/integrations` as any)}
                  iconBg="#f3e8ff"
                  iconColor="#9333ea"
                />
              )}
        ...
        <View className="bg-white mx-4 rounded-3xl px-4 border border-zinc-100">
          <NavRow
            ...
            onPress={() => router.push(`${rootPath}/settings/two-factor` as any)}
