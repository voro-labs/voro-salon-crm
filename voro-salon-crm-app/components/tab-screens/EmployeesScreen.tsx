...
export function EmployeesScreen({ rootPath = "/(tabs)" }: { rootPath?: string }) {
  ...
  function handleAddEmployee() {
    ...
    router.push(`${rootPath}/employees/new` as any)
  }
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <EmployeeCard
              ...
              onPress={() => router.push(`${rootPath}/employees/${item.id}` as any)}
            />
          )}
